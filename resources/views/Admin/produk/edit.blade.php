...
@section('admin.title', 'Admin | EditBerita atau Postingan')
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Ubah Berita atau Postingan</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{route('produk_update', ['id' => $post->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="nama">Nama</label> <small class="text-danger">*</small>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{$post->nama}}">
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori">
                                ...
                                <option value="{{$kategori->id}}" {{$post->kategori_id == $kategori->id ? 'selected' : ''}}>{{$kategori->kategori}}</option>
                                @endforeach
                            </select>
                            @error('kategori')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('berat') is-invalid @enderror" id="berat" name="berat" value="{{$post->Berat}}">  <div class="input-group-append">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" value="{{$post->harga}}">                      </div>
